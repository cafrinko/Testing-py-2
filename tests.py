...
class PartyTests(unittest.TestCase):
    ...
    def test_homepage(self):
        # sends out a fake browser to homepage route
        result = self.client.get("/")
        # data is an attribute of test client
        # check for string of data in returned data
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn('Peirbeir', result.data)
